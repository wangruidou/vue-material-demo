  ...
  <div class="flex-content">
      ...
      <div class="flex-item">
        ...
        <md-card class="screen-tab" v-show="isShow">
            <md-content class="md-scrollbar md-content-screen">
                ...
                <md-divider style="margin-top: 10px"></md-divider>
                <md-field class="screen-content" v-for="item in selectedItemPoints">
                    <label>{{item.name}}</label>
                    ...
                    <md-select v-else-if="item.pointType == 'Boolean'" v-model="filterParams[$utils.trainsIdToKey(item.id)]" :name="$utils.trainsIdToKey(item.id)" :id="$utils.trainsIdToKey(item.id)"
                        @md-selected="handleSelectedParams">
                        <md-option value="none">全部</md-option>
                    ...
                    <span v-else-if="item.pointType == 'Number'">
                        <md-input type="number" v-model="filterParams[$utils.trainsIdToKey(item.id)]" :name="$utils.trainsIdToKey(item.id)" :id="$utils.trainsIdToKey(item.id)" :autocomplete="$utils.trainsIdToKey(item.id)"></md-input>
                    </span>
                    <span v-else>
