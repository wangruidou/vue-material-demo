    ...
    <div class="flex-content">
        <div class="flex-item device-type-tree">
            ...
            <span style="margin-left: 30px;">
                <md-button class="md-icon-button md-dense md-raised md-primary" title="更换设备" @click="changeDevice">
                    <md-icon>refresh</md-icon>
                </md-button>
                <md-button class="md-icon-button md-dense md-raised md-accent" title="卸载设备" @click="removeDevice">
                    <md-icon>reply</md-icon>
                </md-button>
                <md-button class="md-icon-button md-dense md-raised md-accent" title="卸载全部" @click="removeAllDevice">
