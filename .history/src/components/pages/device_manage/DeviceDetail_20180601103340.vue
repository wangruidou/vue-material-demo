                    ...
                    <md-ripple>
                        <md-card-content>
                            <md-list class="md-double-line">
                                <md-subheader>param</md-subheader>
                                <div v-for="(value, key) in currentModel.params" :key="key" class="left-content">
                                    {{value.name}} :
                                </div>                                
                                <md-divider></md-divider>
                                <md-subheader>point</md-subheader>
                                <div v-for="(value, key) in currentModel.points" :key="key">
                                    {{value.name}} : 
                                </div>  
                            </md-list>
                        </md-card-content>
...
export default {
    ...
    computed: {
        ...
        currentPoint() {
            let point = this.$route.params.item.point
            return point
        },
        currentModel() {
