      ...
      <div class="flex-item">
        <md-table v-model="searched" md-card md-fixed-header @md-selected="onSelect">
            <md-table-toolbar>
                ...
                <md-button class="md-icon-button" title="上传文件" @click="document.getElementById("upload_file").click();">
                    <md-icon>publish</md-icon>
                    <md-field id="upload_file" style="display: none" @md-change="handleImportFile">
