<template>
  <div class="flex-content">
      ...
      <div class="flex-item">
        ...
        <DeviceScreen :isShow="isShow" v-on:closeCard="closeCard" v-on:resetCard="resetCard" :paramValue="selectedItemParams" 
            :handleSelectedParams="handleSelectedParams"></DeviceScreen>
