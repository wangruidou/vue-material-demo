<template>
    <div class="flex-content">
        ...
        <div class="flex-item flex-right">
            <div class="flex-item">
                <md-table v-model="devicesOnTrain" md-card style="height: 280px;">
                    <md-table-toolbar>
            ...
            <div class="flex-item" style="margin-top: 5px;">
                <md-table v-model="devicesOffTrain" md-sort="name" md-sort-order="asc" md-card md-fixed-header style="height: 280px;">
                    <md-table-toolbar>
                        <div class="md-toolbar-section-start">
