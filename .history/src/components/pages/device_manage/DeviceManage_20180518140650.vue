<template>
  <div class="flex-content">
      ...
      <div class="flex-item">        
                ...
                <div class="md-layout-item">
                    <md-field>
                        ...
                        <md-select v-model="type" placeholder="请选择设备型号" @md-selected="handleSelected">
                            ...
                            <md-option v-for="item in deviceType" value="${item.typeValue}">{{item.typeName}}</md-option>
                        </md-select>
                    </md-field>
                </div>
                <div class="md-layout-item">
        ...
        <md-table-empty-state md-label="未找到设备" :md-description="`未找到关于'${search}'的设备，请重新搜索.`">
