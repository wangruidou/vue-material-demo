                ...
                if (this.anyparents) {
                    if (this.singleselect == null) {
                        ...
                        if (deviceid != this.singleselect) {
                            ...
                            this.$utils.addParentRelation(this.selectedUnderDevice, this.deviceDataIndex, this.deviceData, deviceid)
                        } else {
                            this.$utils.addParentRelation(this.selectedUnderDevice, this.deviceDataIndex, this.deviceData, this.$route.params.item.deviceid)
                        }
                    }
                } else {
                    this.$utils.addParentRelation(this.selectedUnderDevice, this.deviceDataIndex, this.deviceData, this.$route.params.item.deviceid)
