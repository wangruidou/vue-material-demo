      ...
      <div class="flex-item">        
        ...
        <md-table-toolbar>
            <div class="md-layout md-gutter">
                ...
                <md-snackbar :md-position="center" :md-duration="3000" :md-active.sync="snackbarActive" md-persistent>
                    <span style="text-align: center">{{snackbarInfo}}</span>
                </md-snackbar>
