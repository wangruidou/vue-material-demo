<template>
    <div class="flex-content">
        <TypeTree class="type-tree-content" :rootName="rootName" :selectedPath="selectedPath" :children="typeData" v-on:onNodeSelectedChange="onNodeSelectedChange">
            <md-toolbar slot="tree-toolbar" class="md-dense" md-elevation="0">
                <div class="md-toolbar-section-end">
                    <md-button  @click="returnDeviceManage" title="返回">
        ...
        <div class="flex-item flex-right">
            <div class="flex-item">
                <md-table-toolbar class="md-dense" md-elevation="0">
                    <div class="md-toolbar-section-end">
                ...
                <md-table v-model="devicesOnTrain" md-card md-fixed-header @md-selected="selectOnTrain">                    
            ...
            <div class="flex-item">                
                ...
                <md-table v-model="searched" md-sort="name" md-sort-order="asc" md-card md-fixed-header @md-selected="selectOffTrain">
                    <md-table-row slot="md-table-row" slot-scope="{ item }" :class="getClass(item)" md-selectable="single">
                        <md-table-cell md-label="设备编号">{{ item.devicecode }}</md-table-cell>
