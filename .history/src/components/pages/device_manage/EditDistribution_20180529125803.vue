                ...
                <md-table v-model="devicesOnTrain" md-card style="height: 260px;margin: 0;" @md-selected="selectOnTrain">
                    <md-table-toolbar>
                        <div class="md-toolbar-section-end">
                            <md-button class="md-icon-button md-raised md-primary" title="更换设备" @click="removeDevice">
                                <md-icon>refresh</md-icon>
                            </md-button>
                            <md-button class="md-icon-button md-raised md-accent" title="卸载设备" @click="removeDevice">
                                <md-icon>reply</md-icon>
                            </md-button>
                            <md-button class="md-icon-button md-raised md-accent" title="卸载全部" @click="removeDevice">
