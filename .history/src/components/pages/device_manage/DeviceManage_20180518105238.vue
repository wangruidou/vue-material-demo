  ...
  <div class="flex-content">
      ...
      <div class="flex-item">
        ...
        <md-table-row slot="md-table-row" slot-scope="{ item }">
            ...
            <md-table-cell md-label="设备型号" md-sort-by="devicetype">{{ item.devicetype }}</md-table-cell>
            <md-table-cell md-label="设备种类" md-sort-by="devicekind">{{ item.devicekind }}</md-table-cell>
            <md-table-cell md-label="首次使用日期" md-sort-by="firstusedate">{{ item.firstusedate }}</md-table-cell>
            <md-table-cell md-label="设备状态" md-sort-by="devicestatus">{{ item.devicestatus }}</md-table-cell>
        </md-table-row>
        </md-table>
      </div>
  </div>
