  ...
  <div class="flex-content">
        ...
        <md-table v-model="searched" md-card md-fixed-header @md-selected="onSelect">
            <md-table-toolbar>
                <div class="md-toolbar-section-start">
                    <h3>设备列表</h3>
                    <md-button class="md-raised md-primary" @mouseover="currendNodeid == '' ? (isShow = true) : ()">筛选数据</md-button>
                </div>
      ...
      <md-dialog :md-active.sync="showDialog" class="device-dialog-con">
          ...
          <md-content class="md-scrollbar device-content">
              <DeviceDialogContent :deviceKinds="selectedItemKinds" :params="selectedItemParams" :points="selectedItemPoints"
