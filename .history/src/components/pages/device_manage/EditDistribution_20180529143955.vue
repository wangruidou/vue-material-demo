    ...
    <div class="flex-content">
        ...
        <div class="flex-item flex-right">
            ...
            <div class="flex-item" style="margin-top: 5px;">                
                <md-table v-model="offTrainDevices" md-sort="name" md-sort-order="asc" md-card md-fixed-header style="height: 310px;margin: 0;" @md-selected="selectOffTrain">
                    <md-table-toolbar>
...
export default {
    ...
    created () {
        ...
        // this.searched = this.offTrainDevices
