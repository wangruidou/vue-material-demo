  ...
  <div class="flex-content">
      ...
      <div class="flex-item">
        <md-table v-model="searched" md-card md-fixed-header @md-selected="onSelect">
            <md-table-toolbar>
                <h3 class="md-title" style="flex: 1">设备列表</h3>
                <md-button class="md-icon-button" title="修改">
                    <md-icon>edit</md-icon>
                </md-button>
                <md-button class="md-icon-button" title="添加">
                    <md-icon>add</md-icon>
                </md-button>
                <md-button class="md-icon-button" title="删除">
