<template>
    <div class="flex-content">
        ...
        <md-dialog :md-active.sync="showDialog" :md-click-outside-to-close="clickOutSide">
            ...
            <md-content>
                <div v-if="cannotadd || underDeviceHasParent || addDeviceHasParent || changeOnUnder">
                    <p>
                        {{tipinfo}}
                    </p>
                </div>
...
export default {
    ...
    methods: {
        ...
        removeDevice () {
            ...
            console.log(this.changeOnUnder)
            console.log(this.underDeviceHasParent)
            console.log(this.addDeviceNoParent)
            console.log(this.addDeviceHasParent)
        ...
        addDevice () {
            ...
            for (let i=0;i<childrenItem;i++) {
                if (childrenItem[i].devicetypeid == typeid) {
                    this_.childrenItem.push(childrenItem[i])
                }
            }
            if (this.childrenItem.length == 0) { // 为空不可添加子
