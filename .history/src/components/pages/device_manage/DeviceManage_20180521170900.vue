            ...
            <div class="md-layout md-gutter">
                ...
                <div class="md-layout-item">
                    <md-field>
                        ...
                        <md-tooltip :md-active.sync="tooltipErrorFile">请选择正确的文件</md-tooltip>
                        <md-tooltip :md-active.sync="tooltipSelectFile">请选择文件</md-tooltip>
                    </md-field>
                </div>
...
export default {
  ...
  data: () => ({
    ...
    deviceType: [],
    importInfos: '',
    tooltipSelectFile: false,
    tooltipErrorFile: false
  }),
  methods: {
    searchOnTable() {
    ...
    importDevices() {
        if (this.importInfos == "") {
            this.tooltipSelectFile = true
            return false
        } else {
            if (!(this.importInfos.endsWith('.xlsx') || this.importInfos.endsWith('.xls'))){
                this.tooltipErrorFile = true
                return false
            }
        }
        this.tooltipErrorFile = false
        this.tooltipSelectFile = false
