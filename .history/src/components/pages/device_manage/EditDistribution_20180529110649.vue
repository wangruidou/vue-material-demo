<template>
    <div class="flex-content">
        <div class="flex-item device-type-tree">
            <md-button class="md-icon-button md-dense md-raised md-primary" @click="returnDeviceManage" title="返回">
                <md-icon>keyboard_backspace</md-icon>
            </md-button>
            <span>
                <md-button class="md-icon-button md-dense md-raised md-primary" title="更换设备">
                    <md-icon>refresh</md-icon>
                </md-button>
                <md-button class="md-icon-button md-dense md-raised md-accent" title="卸载设备">
                    <md-icon>reply</md-icon>
                </md-button>
                <md-button class="md-icon-button md-dense md-raised md-accent" title="卸载全部">
        ...
        <div class="flex-item flex-right">            
            <div class="flex-item">
                <md-table v-model="devicesOnTrain" md-card style="height: 260px;margin: 0;">
                    <md-table-toolbar>
            ...
            <div class="flex-item" style="margin-top: 5px;">
                <md-table v-model="devicesOffTrain" md-sort="name" md-sort-order="asc" md-card md-fixed-header style="height: 310px;margin: 0;">
                    <md-table-toolbar>
                        <div class="md-toolbar-section-start">
