      ...
      <div class="flex-item">
        ...
        <md-card class="screen-tab" v-show="isShow">
            ...
            <md-field class="screen-content">
                ...
                <md-select v-model="type" @md-selected="handleSelected">
            ...
            <md-field v-for="item in selectedItemParams" class="screen-content">
                <label for="type">{{item.name}}</label>
                <md-select v-model="type" @md-selected="handleSelectForParams">
                    <md-option value="全部">全部</md-option>
                    <md-option v-for="(v, k) in item.enable" :value="v.typeValue" :key="k">{{v}}</md-option>
                </md-select>
            </md-field>
        </md-card>
