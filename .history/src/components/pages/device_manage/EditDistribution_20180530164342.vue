...
const removeFromArray = (array, removedArray) => {
    let temp = []
    let temparray = []
    removedArray.forEach(function(item) {
        temp[item] = typeof item
    })
...
export default {
    ...
    methods: {
        ...
        dialogConfirm () {
            if(this.removeAll) {
                console.log(this.allDevicesOnTrain)
                console.log(this.devicesOnTrain)
                console.log(removeFromArray(this.allDevicesOnTrain, this.devicesOnTrain))
