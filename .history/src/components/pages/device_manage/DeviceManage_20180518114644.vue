        ...
        <md-table-toolbar>
            <div class="md-layout md-gutter">
                <div class="md-layout-item">
                    <md-field>
                        <label for="movie">设备型号</label>
                        <md-select v-model="movie" name="movie" id="movie" placeholder="请选择设备型号" @md-selected="handleSelected">
                            <md-option value="0">全部</md-option>
                            <md-option value="JT1-CZ2000">JT1-CZ2000</md-option>
                            <md-option value="JT2-XX333">JT2-XX333</md-option>
                            <md-option value="JT3-SAF111">JT3-SAF111</md-option>
                        </md-select>
                    </md-field>
                </div>
                <div class="md-layout-item">
