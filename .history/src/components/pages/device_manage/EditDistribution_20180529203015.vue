            ...
            <div class="flex-item">
                <md-table-toolbar class="md-dense">
                    <div class="md-toolbar-section-end">
                        <md-button class="md-fab md-mini md-dense md-primary" title="更换设备" @click="changeDevice">
                            <md-icon>refresh</md-icon>
                        </md-button>
                        <md-button class="md-fab md-mini md-dense md-plain" title="卸载设备" @click="removeDevice">
                            <md-icon>reply</md-icon>
                        </md-button>
                        <md-button class="md-fab md-mini md-dense md-plain" title="卸载全部" @click="removeAllDevice">
