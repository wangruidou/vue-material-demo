<template>
    <div class="flex-content">
        <div class="flex-item device-type-tree">
            ...
            <md-button class="md-icon-button md-dense md-raised md-accent btn-position" title="更换设备">
                <md-icon>refresh</md-icon>
            </md-button>
            <md-button class="md-icon-button md-dense md-raised md-accent btn-position" title="卸载设备">
                <md-icon>reply</md-icon>
            </md-button>
            <md-button class="md-icon-button md-dense md-raised md-accent btn-position" title="卸载全部">
