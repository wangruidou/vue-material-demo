<template>
    <div class="flex-content">
        ...
        <div class="flex-item">
            <div> 
                <md-table v-model="devicesOnTrain" md-card  class="md-scrollbar device-content">
                    <md-table-toolbar>
            ...
            <div>
                <md-table v-model="devicesOffTrain" md-sort="name" md-sort-order="asc" md-card md-fixed-header  class="md-scrollbar device-content">
                    <md-table-toolbar>
                        <div class="md-toolbar-section-start">
