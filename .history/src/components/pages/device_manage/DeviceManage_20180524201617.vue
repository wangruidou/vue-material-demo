        ...
        <md-card class="screen-tab" v-show="isShow">
            <md-content class="md-scrollbar md-content-screen">
                ...
                <md-field class="screen-content" v-for="item in selectedItemPoints">
                    ...
                    <md-input v-else-if="item.pointType == 'Number'" type="number" v-model="filterParams[$utils.trainsIdToKey(item.id)]" :name="$utils.trainsIdToKey(item.id)" :id="$utils.trainsIdToKey(item.id)" :autocomplete="$utils.trainsIdToKey(item.id)"></md-input>
