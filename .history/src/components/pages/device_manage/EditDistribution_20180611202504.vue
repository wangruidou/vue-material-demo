            ...
            <md-content>
                ...
                <div v-else>
                    ...
                    <div v-if="anyparents">
                        请选择需要配属的设备
                        <md-field>
                            <md-select v-model="singleselect" :name="childrenItem.deviceid" :id="childrenItem.deviceid" @md-selected="handleSelect">
                                <md-option v-for="(v, k) in singleselect" :value="v" :key="k">{{v}}</md-option>
                            </md-select>
                        </md-field> 
                    </div>
                </div>
