  ...
  <div class="flex-content">
      ...
      <div class="flex-item">
        ...
        <md-card class="screen-tab" v-show="isShow">
            ...
            <md-field class="screen-content" v-for="item in selectedItemKinds">
                <label for="">设备型号</label>
                <md-select v-model="" name="" id="" @md-selected="handleSelected">
  ...
  methods: {
    ...
    handleSelectedParams (value) {
        ...
        this.selectedItemParams.forEach(function (item) {
            ...
            if(selectValue != "none"){
                this_.param_key.push(param)
                this_.param_value.push(selectValue)
            }
        })
    }
  },
