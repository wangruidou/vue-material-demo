<template>
    <div class="flex-content">
        ...
        <md-dialog :md-active.sync="showDialog">
            ...
            <md-content>
                <div v-if="underDeviceHasParent">
                    <p>
                        你选择的“其他设备”已经配属，是否卸载并且配属在当前设备上？
                    </p>
                </div>
                <div v-else>
...
const deleteRepeat = (item1, item2) => {
    item2.forEach(function(v) {
        let index = item1.indexOf(v)
        if(index >= 0){
...
export default {
    ...
    methods: {
        ...
        changeDevice () {
            ...
            if (this.selectedUnderTrain.parentid != '') {
            ...
            this.underDevice.push(this.selectedOnTrain)            
    ...
    created () {
        let this_ = this
        let onDeviceIndex = []
        this.$route.params.children.forEach(function(item) {
        ...
        console.log(deleteRepeat(this.$store.state.deviceData, this.allOnCurrentDevice))
        console.log(this.$store.state.deviceData)
    },    
    watch: {
