  ...
  <div class="flex-content">
      ...
      <md-dialog :md-active.sync="showDialog">
          ...
          <md-content class="md-scrollbar device-content">
              <DeviceDialogContent :deviceKinds="selectedItemKinds" :points="selectedItemPoints"
...
const isEmptyChildren = (children, typeid) => {
    let this_ = this
    children.forEach(function(item) {
        if (this_.$utils.isEmptyChildren(item.children)){
            return []
        } else {
            if (typeid == item.typeid){
                return item.children
            } else {
                isEmptyChildren(item.children, typeid)
            }
        }
    })
}
  ...
  methods: {
    ...
    editChildren () {        
        if (this.selectedItem == null) {
            ...
            console.log(isEmptyChildren(this.typeData, typeid))
