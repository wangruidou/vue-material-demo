  ...
  <div class="flex-content">
      ...
      <div class="flex-item">
            ...
            <md-table-toolbar>
                <div class="md-layout md-gutter">
                    ...
                    <div class="md-layout-item">
                        ...
                        <md-button class="md-raised md-primary">新增设备</md-button>
                    </div>
        ...
        <md-card class="screen-tab" v-show="isShow">
            <md-button class="md-raised md-primary" @click="showDialog = true">openDialog</md-button>
      ...
      <DeviceDialog :md-active.sync="showDialog"></DeviceDialog>
  </div>
</template>
