            ...
            <md-content class="md-scrollbar md-content-screen">
                ...
                <md-field class="screen-content" v-for="item in selectedItemPoints">
                    ...
                    <span v-else-if="item.pointType == 'Number'">
                        <md-input v-model="filterParams[$utils.trainsIdToKey(item.id)]" :name="$utils.trainsIdToKey(item.id)" :id="$utils.trainsIdToKey(item.id)" :autocomplete="$utils.trainsIdToKey(item.id)"></md-input>
                    </span>
                    <span v-else>
