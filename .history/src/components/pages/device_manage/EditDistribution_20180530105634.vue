<template>
    <div class="flex-content">
        ...
        <md-dialog :md-active.sync="showDialog">
            ...
            <md-content style="width: 350px; height: 120px;">
                <md-field>
                    <label for="reason">卸载原因</label>
                    <md-select v-model="reason" name="reason" id="reason">
                        <md-option value="fight-club">检修卸载</md-option>
                        <md-option value="godfather">良品卸载</md-option>
            ...
            <md-dialog-actions>
                ...
                <md-button class="md-accent" @click="showDialog = false">确定</md-button>
            </md-dialog-actions>
        </md-dialog>
    </div>
</template>
