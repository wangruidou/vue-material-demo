<template>
  <div class="flex-content">
      ...
      <div class="flex-item">
        ...
        <DeviceScreen :isShow="isShow" v-on:closeCard="closeCard" v-on:resetCard="resetCard" :paramsData="selectedItemKinds"
            v-on:handleSelected="handleSelected"></DeviceScreen>
            ...
            <md-content class="md-scrollbar device-content">
                <table style="width: 100%; padding: 15px;">
                    <tr v-for="i in 5">
                        ...
                        <td>
                            <md-field>
                                <md-input v-model="initial" placeholder="请输入设备编号..."></md-input>
                            </md-field>
                        </td>
                    </tr>
                </table>
