      ...
      editDlgSave () {
          ...
          if (index >= 0){
            let item = {
              ...
              remarks: this.manufacturerReamrk
            }
            this.$ajax.post('manufacturers/edit', {
              msg: JSON.stringify(item)
            }) 
            .then(function (response) {
              console.log(response)
              this.manufacturers[index].name = this.manufacturerName
              this.manufacturers[index].remarks = this.manufacturerReamrk
